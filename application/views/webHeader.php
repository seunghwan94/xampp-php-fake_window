...
<body style="overflow: hidden;">
    <header>
      ...
      <div class="gap-2" style="display:flex; justify-content:space-between; align-items:center;padding: 3px 10px;background:#aaaaaa;border-bottom: 2px solid #333;">
        <div>
          <img src="../../assets/img/earth.png" style="width:20px;"> 
          &nbspmagolee - internet
        </div>
        <div>
      ...
      <div class="gap-2" style="display:flex; justify-content:space-between; align-items:center;padding: 3px 10px; background:#aaaaaa;border-bottom: 2px solid #333;">
        <div>
          ...
          <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
            <div class="btn-group" role="group">
              <button type="button" class="btn dropdown-toggle p-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background:lightgray">
                <h1 style="font-size:14px;margin:0px">편집(E)</h1>
              </button>
              <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" style="">
                <a class="dropdown-item" href="#">Dropdown link</a>
                <a class="dropdown-item" href="#">Dropdown link</a>
          ...
          <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
            <div class="btn-group" role="group">
              <button type="button" class="btn dropdown-toggle p-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background:lightgray">
                <h1 style="font-size:14px;margin:0px">즐겨찾기(A)</h1>
              </button>
              <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" style="">
                <a class="dropdown-item" href="#">Dropdown link</a>
                <a class="dropdown-item" href="#">Dropdown link</a>
        ...
        <div>
          <img src="../../assets/img/window.png" style="width:25px;"> 
        </div>
      </div>
      <!-- 세번째 줄 -->
      <div class="gap-2" style="display:flex; justify-content:flex-start; align-items:center;padding: 3px 10px;background:#aaaaaa;border-bottom: 2px solid #333;">
        ...
        <div class="input-with-icon" style="width: 75%;display:flex;">
          <img src="../../assets/img/internet.png" alt="icon">
          <input class="form-control" id="readOnlyInput" type="text" placeholder="www.magolee.com" readonly="">
          <button type="button" class="btn btn-primary btn-sm p-2 m-0" style='background:#aaaaaa;color:black'><h1 style="font-size:14px;margin:0px">검색</h1></button>
        </div>
      </div>
    </header>
